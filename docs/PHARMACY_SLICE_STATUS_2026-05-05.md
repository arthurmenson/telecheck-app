...
**Final commit (prescribe surface):** Sprint 35 / SI-001 scaffold-rebuild landing per Promotion Ledger entry P-011; 11 routes mounted per `src/modules/pharmacy/routes.ts`
