...
| **SI-003** | DOMAIN_EVENTS v5.2 placeholder event-type strings (28 placeholder strings across the 3 slices' events.ts files) | OPEN — targets **next-available after P-018/SI-008** per SI-003 source file Resolution-expectations block (originally P-013 per v0.1 plan; P-013 claimed by SI-007; P-014 claimed by SI-002; P-017 claimed by SI-005; P-018 claimed by SI-008; SI-003 retargeted 2026-05-17) |
...
| **SI-005** | consults / consult_events schema canonical ratification (currently shipped as engineering-authored placeholder per migrations 020 + 021) | OPEN — targets **P-017** (per SI-005 own Status block; added 2026-05-17 per PR #175 R2 HIGH closure to make the target authoritative on its own Status block) |
