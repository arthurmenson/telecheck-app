param([Parameter(Mandatory=$true)][string]$RuntimeDirectory, [ValidateSet(56579,56585)][int]$Port = 56579)
...
$taskPinProfile = if ($Port -eq 56579) { 'patient-pin-reset-author-v1' } else { 'patient-pin-reset-author-v4-097' }
