...
export default defineConfig({
  test: {
    ...
    // Integration files share one database and take transaction-scoped audit
    // locks. Serialize files while retaining fresh process/module isolation.
    // Vitest 4 ignores the old forks.singleFork object; its supported option
    // is fileParallelism (https://vitest.dev/config/fileparallelism).
    pool: 'forks',
